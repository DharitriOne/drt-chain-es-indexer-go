...
INDICES_LIST=("rating" "transactions" "blocks" "validators" "miniblocks" "rounds" "accounts" "accountshistory" "receipts" "scresults" "accountsdct" "accountsdcthistory" "epochinfo" "scdeploys" "tokens" "tags" "logs" "delegators" "operations" "dcts" "values" "events")
