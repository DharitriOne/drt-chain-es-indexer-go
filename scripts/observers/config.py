...
def prepare_observer(shard_id, working_dir, config_folder):
    ...
    shutil.copyfile(working_dir / "drt-chain-go/cmd/node/node", working_dir_observer / "node/node")
...
def generate_new_config(working_dir):
    drt_chain_go_folder = working_dir / "drt-chain-go" / "scripts" / "testnet"
...
def clone_drt_chain_go(working_dir):
    print("cloning drt-chain-go....")
    drt_chain_go_folder = working_dir / "drt-chain-go"
...
def prepare_seed_node(working_dir):
    ...
    seed_node = Path.home() / "DharitriOne/testnet/seednode"
...
def prepare_proxy(working_dir):
    ...
    drt_chain_proxy_go_folder = working_dir / "drt-chain-proxy-go"
...
def generate_config_for_local_testnet(working_dir):
    drt_chain_local_testnet_scripts = working_dir / "drt-chain-go/scripts/testnet"
    ...
    config_folder = Path.home() / "DharitriOne/testnet/node/config"
