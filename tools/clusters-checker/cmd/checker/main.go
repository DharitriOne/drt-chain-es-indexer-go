...
import (
	...
	"github.com/DharitriOne/drt-chain-es-indexer-go/tools/clusters-checker/pkg/checkers"
	"github.com/DharitriOne/drt-chain-es-indexer-go/tools/clusters-checker/pkg/config"
