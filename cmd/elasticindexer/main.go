...
import (
	...
	"github.com/DharitriOne/drt-chain-es-indexer-go/factory"
	"github.com/DharitriOne/drt-chain-es-indexer-go/metrics"
...
func main() {
	...
	app.Authors = []cli.Author{
		{
			Name:  "The DharitriOne Team",
			Email: "contact@DharitriOne.com",
		},
	}
